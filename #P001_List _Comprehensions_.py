...
# list comprehensions make the code cleaner as well works faster than normal loops.

# ----- ----- -----
l=[i for i in range(10)]  # integer list from 0 to 100.
...
# ----- ----- -----
m=[i**2 for i in range(10)]  # list of square of integers from 1 to 100.
